        ...
        return (
            <div>
                ...
                <div class="md-radio-inline">
                    <div class="md-radio">
                        <input value = "A3" onChange = {this.props.change} type="radio" id="radio53" name="radio2" class="md-radiobtn" />
                    ...
                    <div class="md-radio">
                        <input value = "A4" type="radio" id="radio54" name="radio2" class="md-radiobtn" />
                    ...
                    <div class="md-radio">
                        <input value = "A5" type="radio" id="radio55" name="radio2" class="md-radiobtn" />
